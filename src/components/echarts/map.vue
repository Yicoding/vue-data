...
import macarons from 'assets/json/macarons.json'
export default {
    data () {
        return {
            myChart: null,
    ...
    mounted() {
        this.$nextTick(() => {
            ...
            this.$refs.line.style.height = '500px'
    ...
    methods: {
        ...
        initLine() {
			...
			this.echarts.registerTheme('macarons', macarons) // 注册主题
            this.myChart = this.echarts.init(this.$refs.line, 'macarons') // 使用主题
            var option = {
